            ...
            <div class="row">
                ...
                <div class="col-md-2 mt-4">
                    ...
                    <div class="row">
                     ...
                     <table>
                          <tr>
                              <td><a href="https://www.facebook.com/sharer.php?u=<?php echo site_url().'detail_infografik/artikel_infografik/'.$detail->judul ?>" target="_blank"><button type="button" class="btn btn-social-icon btn-facebook btn-rounded " style="width: 50px; height: 50px; padding: 1; border-radius: 50px;" ><i class="fa fa-facebook-official"></i></button></a></td>
                              <td><a href="http://www.instagram.com/sharer.php?url=<?php echo site_url().'detail_infografik/artikel_infografik/'.$detail->id_infografik ?>"><button type="button" class="btn btn-social-icon btn-instagram btn-rounded" style="width: 50px; height: 50px; padding: 1; border-radius: 50px;"><i class="fa fa-instagram"></i></button></a></td>
                              <td><a href="https://wa.me/?text=<?php echo $detail->judul?>%0AKlik%20Untuk%20melihat%20selengkap%20nya%20Kunjungi%20web%20resmi%20kami%20<?php echo site_url().'detail_infografik/artikel_infografik/'.$detail->id_infografik ?>" target="_blank"><button type="button" class="btn btn-social-icon btn-wa btn-rounded" style="width: 50px; height: 50px; padding: 1; border-radius: 50px;"><i class="fa fa-whatsapp"></i></button></a></td>
                          </tr>
                      </table>
                     </div>
                    </div>
