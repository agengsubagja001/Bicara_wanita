        ...
        <div class="container" style="max-width: 1340px;">
            ...
            <div class="row">
                ...
                <div class="col-md-12 text-center">
                    <h1 style="position: relative; top: 80px; font-family: Poppins; font-style: normal; font-weight: bold; font-size: 32px; color: #333333;">Kampanye Menuju Indonesia Bebas AIDS 2030</h1>
                </div>
                <!-- akhir judul -->
                <!-- awal konten artikel program -->
                <div class="col-md-12 text-center mt-5">
                    <img src="assets/img/banner_aids.png" style="position: relative; top: 50px; width: 80%; height: auto" alt="">
                </div>
                <div class="col-md-12">
